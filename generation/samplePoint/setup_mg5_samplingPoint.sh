...
echo "======================================================"
# We use 'EOF' to prevent bash from evaluating any special characters inside the patch
cat << 'EOF' > smeft_fix.patch
...
@@ -62,12 +63,12 @@ GC_13 = Coupling(name = 'GC_13',
...
@@ -131,11 +132,11 @@ GC_30 = Coupling(name = 'GC_30',
...
@@ -151,11 +152,11 @@ GC_35 = Coupling(name = 'GC_35',
...
@@ -398,12 +399,12 @@ GC_97 = Coupling(name = 'GC_97',
...
@@ -582,12 +583,12 @@ GC_143 = Coupling(name = 'GC_143',
...
@@ -606,12 +607,12 @@ GC_149 = Coupling(name = 'GC_149',
...
@@ -1354,12 +1355,12 @@ GC_336 = Coupling(name = 'GC_336',
                    order = {'QED':1})
...
@@ -1395,11 +1396,11 @@ GC_346 = Coupling(name = 'GC_346',
...
@@ -1410,12 +1411,12 @@ GC_350 = Coupling(name = 'GC_350',
...
@@ -1530,12 +1531,12 @@ GC_380 = Coupling(name = 'GC_380',
...
@@ -1546,12 +1547,12 @@ GC_384 = Coupling(name = 'GC_384',
...
@@ -2394,12 +2395,12 @@ GC_596 = Coupling(name = 'GC_596',
...
@@ -2442,12 +2443,12 @@ GC_608 = Coupling(name = 'GC_608',
...
@@ -2498,12 +2499,12 @@ GC_622 = Coupling(name = 'GC_622',
...
@@ -2546,12 +2547,12 @@ GC_634 = Coupling(name = 'GC_634',
...
@@ -2618,12 +2619,12 @@ GC_652 = Coupling(name = 'GC_652',
                    order = {'QED':1})
...
@@ -2762,12 +2763,12 @@ GC_688 = Coupling(name = 'GC_688',
...
@@ -2810,12 +2811,12 @@ GC_700 = Coupling(name = 'GC_700',
...
@@ -2866,12 +2867,12 @@ GC_714 = Coupling(name = 'GC_714',
                    order = {'NP':1,'NPcdW':1,'QED':3})
...
@@ -3642,12 +3643,12 @@ GC_908 = Coupling(name = 'GC_908',
                    order = {'QED':1})
...
@@ -3786,12 +3787,12 @@ GC_944 = Coupling(name = 'GC_944',
                    order = {'NP':1,'NPcdW':1,'QED':4})
...
@@ -3834,12 +3835,12 @@ GC_956 = Coupling(name = 'GC_956',
                    order = {'NP':1,'NPcdW':1,'QED':3})
...
@@ -3890,12 +3891,12 @@ GC_970 = Coupling(name = 'GC_970',
                    order = {'NP':1,'NPcdW':1,'QED':3})
...
@@ -4570,12 +4571,12 @@ GC_1140 = Coupling(name = 'GC_1140',
                     order = {'NP':1,'NPcuB':1,'QED':3})
...
@@ -4618,12 +4619,12 @@ GC_1152 = Coupling(name = 'GC_1152',
                     order = {'NP':1,'NPcuW':1,'QED':4})
...
@@ -4674,12 +4675,12 @@ GC_1166 = Coupling(name = 'GC_1166',
                     order = {'NP':1,'NPcuB':1,'QED':2})
...
@@ -4722,12 +4723,12 @@ GC_1178 = Coupling(name = 'GC_1178',
                     order = {'NP':1,'NPcuW':1,'QED':3})
